...
async function runtimeSourceEvidence() {
  const explicit = [
    ...
    path.join(WEB_ROOT, "src/components/svg-canvas.tsx"),
    path.join(WEB_ROOT, "src/features/canvas/exact-camera-clip.ts"),
    path.join(WEB_ROOT, "src/features/canvas/types.ts"),
    path.join(WEB_ROOT, "src/features/canvas/viewport.ts"),
