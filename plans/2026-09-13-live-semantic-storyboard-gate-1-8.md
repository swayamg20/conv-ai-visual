...
- A 30-to-45-second canonical capture would repeat the slow-pacing weakness already identified during visual review and conflicts with the new 400-to-800-millisecond thought-beat language. Gate 1.8 therefore treats 12 to 20 seconds as the complete five-beat visual target; evidence capture may include surrounding interaction time but cannot relabel it as authored duration.
...
- Decision: Pace the canonical five-beat comparison within 12 to 20 seconds of authored visual time. Rationale: the learner should see a deliberate explanatory sequence without the long holds that made earlier evidence feel slow; provider waiting is measured separately and never padded into the animation. Date/author: 2026-09-13, Codex with Swam Gupta's prior pacing feedback.
